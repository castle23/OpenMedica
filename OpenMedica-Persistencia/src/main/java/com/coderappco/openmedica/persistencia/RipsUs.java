...
public class RipsUs implements Serializable {
    ...
    private String sexo;
    @Size(max = 2)
    @Column(name = "cod_dep_res")
    private String codDepRes;
    @Size(max = 3)
    @Column(name = "cod_mun_res")
    private String codMunRes;
    @Size(max = 1)
    @Column(name = "zona_res")
    private String zonaRes;
    @JoinColumn(name = "id_rip_almacenado", referencedColumnName = "id_rip_almacenado", insertable = false, updatable = false)
    ...
    public String toString() {
        return "com.coderappco.persistence.RipsUs[ ripsUsPK=" + ripsUsPK + " ]";
    }
