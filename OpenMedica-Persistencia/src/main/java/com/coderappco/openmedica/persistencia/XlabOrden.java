...
@NamedQueries({
    ...
    @NamedQuery(name = "XlabOrden.findByFechaEliminacion", query = "SELECT x FROM XlabOrden x WHERE x.fechaEliminacion = :fechaEliminacion"),
    @NamedQuery(name = "XlabOrden.findByFechaCreacion", query = "SELECT x FROM XlabOrden x WHERE x.fechaCreacion = :fechaCreacion"),
    @NamedQuery(name = "XlabOrden.findByFechaActualizacion", query = "SELECT x FROM XlabOrden x WHERE x.fechaActualizacion = :fechaActualizacion")})
public class XlabOrden implements Serializable {
    ...
    @ManyToMany(mappedBy = "xlabOrdenList")
    ...
    public String toString() {
        return "com.coderappco.persistence.XlabOrden[ id=" + id + " ]";
    }
