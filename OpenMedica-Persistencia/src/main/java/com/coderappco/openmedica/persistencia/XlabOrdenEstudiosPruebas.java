...
@NamedQueries({
    ...
    @NamedQuery(name = "XlabOrdenEstudiosPruebas.findByResultado", query = "SELECT x FROM XlabOrdenEstudiosPruebas x WHERE x.resultado = :resultado")})
public class XlabOrdenEstudiosPruebas implements Serializable {
    ...
    public String toString() {
        return "com.coderappco.persistence.XlabOrdenEstudiosPruebas[ id=" + id + " ]";
    }
